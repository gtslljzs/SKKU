...
void Basic_AI_player::debug_print_my_live_line_count(int ll){
	cout << "================================================ my " << ll << " ================================================" << endl;
...
void Basic_AI_player::debug_print_op_live_line_count(int ll){
	cout << "================================================ op " << ll << " ================================================" << endl;
	for(int y=BOARD_SIZE - 1; y>=0;y--){
		for(int x=0; x < BOARD_SIZE; x++){
...
Basic_AI_player::Basic_AI_player(){
	this->my_weight[0] = 1;
	this->my_weight[1] = 3;
	this->my_weight[2] = 9;
	this->my_weight[3] = 9000;
	this->my_weight[4] = 900000;
	this->my_weight[5] = 900000;
	this->my_weight[6] = 0;

	this->op_weight[0] = 1;
	this->op_weight[1] = 2;
	this->op_weight[2] = 4;
	this->op_weight[3] = 300;
	this->op_weight[4] = 30000;
	this->op_weight[5] = 30000;
	this->op_weight[6] = 0;

}

Basic_AI_player::Basic_AI_player(float my_0, float my_1, float my_2, float my_3, float my_4, float my_5, float my_6,
									float op_0, float op_1, float op_2, float op_3, float op_4, float op_5, float op_6){
	this->my_weight[0] = my_0;
	this->my_weight[1] = my_1;
	this->my_weight[2] = my_2;
	this->my_weight[3] = my_3;
	this->my_weight[4] = my_4;
	this->my_weight[5] = my_5;
	this->my_weight[6] = my_6;
...
void Basic_AI_player::init_board(){
...
void Basic_AI_player::init_live_line_count(){
	int tmp;
	for(int x = 0; x<BOARD_SIZE; x++){
...
void Basic_AI_player::init_player(int my_color, int op_color){
...
void Basic_AI_player::set_forced_move(int color, int x, int y){
...
pair< pair<int, int>, pair<int, int> > Basic_AI_player::return_fixed_start_move(){
	pair< pair<int, int>, pair<int, int> > result;
...
pair<int, int> Basic_AI_player::return_half_move(pair< pair<int, int>, pair<int, int> > last_op_move, int half_turn){
	...
	for(x=0;x<BOARD_SIZE;x++){
		for(y=0;y<BOARD_SIZE;y++){
			if(this->board[x][y] == EMPTY){
				tmp = 0;
				for(z=0;z<7;z++){
					tmp += this->my_live_line_count[x][y][z]*this->my_weight[z] + this->op_live_line_count[x][y][z]*this->op_weight[z];
				}
...
pair< pair<int, int>, pair<int, int> > Basic_AI_player::return_move(pair< pair<int, int>, pair<int, int> > last_op_move){
...
void Basic_AI_player::set_move_update_live_line(int color, int x, int y){ // should add checking over 6
