...
#ifndef BASIC_V1_AI_PLAYER_H
#define BASIC_V1_AI_PLAYER_H

class Basic_v1_AI_player : public AI_player{
	protected:
		float my_weight[2][7];
		float op_weight[7];
	...
	public:
		Basic_v1_AI_player();
		Basic_v1_AI_player(float my_0_0, float my_0_1, float my_0_2, float my_0_3, float my_0_4, float my_0_5, float my_0_6,
