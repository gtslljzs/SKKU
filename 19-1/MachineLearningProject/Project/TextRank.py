...
class SentenceTokenizer(object):
    ...
    def text2sentences(self, text):
        ...
        for idx in range(1, len(self.sentences)):
...
output = open('Articles_Politics1.csv', 'w', encoding='utf-8', newline='')
wr = csv.writer(output)

# input = open('Articles_Politics.csv', 'r', encoding='utf-8')
# rdr = csv.reader(input)

rdr = pd.read_csv('test_articles_temp.csv', header=None)
...
for line in rdr[0]:
    ...
    print('out')
    row = textrank.summarize(leng2)
    print(len(row))
    if len(textrank.sorted_sent_rank_idx) is not (leng):
        print(text)
        print(tmp2)
        print(textrank.nouns)
        continue

    output = []
    for idx in row:
        output.append(tmp2[idx])
    output1 = ' '.join(output)
    wr.writerow([output1])
...
# output = open('train_articles_textrank.csv', 'w', encoding='UTF-8', newline='')
# writer = csv.writer(output)
#
# input = open('train_articles.csv', 'r', encoding='UTF-8')
# reader = csv.reader(input)
# print(reader)

# reader = pd.read_csv('test_articles_temp.csv', header=None)
# print(len(reader[0]))
# summary = []
#
...
#     print(len(row))
#
#     if len(textrank.sorted_sentence_rank_idx) is not (leng):
#         print(text)
#         print(tmp2)
#         print(textrank.nouns)
#         continue
